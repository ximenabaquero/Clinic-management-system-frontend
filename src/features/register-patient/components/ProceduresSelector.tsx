      ...
      <div className="grid grid-cols-1 gap-4">
        {PROCEDURE_GROUPS.map((group) => (
          <details
            key={group.id}
            open={false}
            className="rounded-2xl bg-white shadow-[0_4px_14px_-2px_rgba(5,150,105,0.25)] hover:shadow-[0_4px_18px_-2px_rgba(5,150,105,0.45)] transition-shadow duration-200 ring-1 ring-green-100"
          >
        ...
        text-white text-xs font-bold shadow-sm"
                  ...
                  <ChevronDownIcon className="w-4 h-4 text-emerald-700 transition-transform duration-200 details-open:rotate-180" />
                </div>
              </div>
            </summary>
