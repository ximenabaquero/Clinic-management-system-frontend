  ...
  return (
    <>
      ...
      {stats.critCount === 0 && stats.lowCount === 0 && insumos.length > 0 && (
        <div className="mb-4 p-4 bg-[#BF2496]/10 border-l-4 border-[#BF2496] rounded-lg">
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-[#BF2496]" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <p className="text-sm font-semibold text-[#BF2496]">
