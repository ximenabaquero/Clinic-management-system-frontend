...
export default function RemitentesTable({
  remitentes,
  onEdit,
  onChangeStatus,
}: Props) {
                    ...
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      {r.status !== "ACTIVE" && (
                        <button
                          title="Activar"
                          onClick={() =>
                            onChangeStatus(r.id, "activar", "Activar")
                          }
                      ...
                      {r.status === "ACTIVE" && (
                        <button
                          title="Inactivar"
                          onClick={() =>
                            onChangeStatus(r.id, "inactivar", "Inactivar")
                          }
                      ...
                      {r.status !== "FIRED" && (
                        <button
                          title="Despedir"
                          onClick={() =>
                            onChangeStatus(r.id, "despedir", "Despedir")
                          }
